"""
Async Python Lab - Exercise 3: Concurrent Execution - SOLUTION

Complete implementation of concurrent execution patterns using asyncio.gather, as_completed, and semaphores.
"""
...
async def performance_comparison():
    ...
    print(f"Gather execution time: {gather_time:.2f}s")
    ...
    print(f"As_completed execution time: {as_completed_time:.2f}s")
    ...
    print(f"Rate limited execution time: {rate_limited_time:.2f}s")

    # Calculate speedups
    print("\n=== Speedup Analysis ===")
    print(f"Gather speedup vs sequential: {sequential_time / gather_time:.2f}x")
    print(f"As_completed speedup vs sequential: {sequential_time / as_completed_time:.2f}x")
    print(f"Rate limited speedup vs sequential: {sequential_time / rate_limited_time:.2f}x")
