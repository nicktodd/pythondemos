"""
Async Python Lab - Exercise 4: Async Context Managers - SOLUTION

Complete implementation of async context managers for proper resource management.
"""
...
async def AsyncTimer():
    ...
    try:
        ...
        print(f"Timer finished. Elapsed time: {timer.elapsed:.2f}s")
...
async def nested_context_managers():
    ...
    try:
        ...
        print(f"Total nested operations time: {outer_timer.elapsed:.2f}s")
...
async def comprehensive_demo():
    ...
    print(f"Measured time: {timer.elapsed:.2f}s")
